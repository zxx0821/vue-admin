<template>
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom:0">
      <el-form :inline="true" :model="filterName">
        ...
        <el-form-item label="管理员">
          <el-select v-model="filterName.isAdmin" placeholder="是">
    ...
    <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="handleSelectionChange" style="width: 100%;">
      ...
      <el-table-column prop="isAdmin" label="管理员" width="120" :formatter="formatAdmin">
      </el-table-column>
      ...
      methods: {
        ...
        getUsers(){
          let param = {
            ...
            isAdmin: this.filterName.isAdmin
          };
