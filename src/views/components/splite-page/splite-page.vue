  ...
  <div>
    <Card :padding="0">
      <div class="split-pane-con">
        <splitePane :style="{height: '100%'}" right :min="20" max="100px" @on-trigger-moving="handleMoving" direction="horizontal" v-model="triggerOffset">
          <div slot="left" style="height: 100%;">
            <splitePane :style="{height: '100%'}" direction="vertical" v-model="triggerOffsetV">
              ...
              <div slot="bottom" style="background: #A2EDB6;height: 100%;">
                <splitePane ref="pane" :style="{height: '100%'}" direction="horizontal" v-model="triggerOffsetMin">
...
<script>
import splitePane from './components/splite-pane'
export default {
  name: 'splite-page',
  components: {
    splitePane
