<template>
  <div class="app-container forceChart">
    <div style="width:100%;height:100%" id="forcetocircle"> 111</div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      initChart(){
        let _this = this;
        _this.chart = _this.$echarts.init(document.getElementById('forcetocircle'));
